var UIHonorHireView = (function (_super) {
    __extends(UIHonorHireView, _super);
    function UIHonorHireView() {
        _super.call(this);
    ...
    var __egretProto__ = UIHonorHireView.prototype;
    ...
    __egretProto__.setDatas = function (parent, guiLayer, select_index) {
        this.ui_parent = parent;
        this.guiLayer = guiLayer;
        this.job_type = select_index;
    };
    __egretProto__.resetHonorHireInfo = function (datas_list) {
        this.hired_knights_list = [];
    ...
    __egretProto__.finishHonorHire = function (result, data) {
    ...
    __egretProto__.finishRefreshHonorHireByDiamond = function (result, datas) {
        if (this.ui_wait != null) {
            this.ui_wait.close();
        }
        if (result != 0) {
    ...
    return UIHonorHireView;
})(egret.gui.Panel);
UIHonorHireView.prototype.__class__ = "UIHonorHireView";
