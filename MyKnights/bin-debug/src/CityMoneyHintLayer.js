var CityMoneyHintLayer = (function (_super) {
    __extends(CityMoneyHintLayer, _super);
    function CityMoneyHintLayer() {
        _super.call(this);
        this.end_time = 0;
    }
    var __egretProto__ = CityMoneyHintLayer.prototype;
    __egretProto__.addCityMoneyHintLayer = function (city_layer, money, end_time) {
    ...
    __egretProto__.refreshTick = function () {
        var current_time = Utils.time();
        var left_seconds = this.end_time - current_time;
        this.tick_text.text = Utils.getTimeStr(left_seconds);
    };
    ...
    return CityMoneyHintLayer;
})(egret.DisplayObjectContainer);
CityMoneyHintLayer.prototype.__class__ = "CityMoneyHintLayer";
