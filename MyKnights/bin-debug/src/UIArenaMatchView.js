//removeEventListener
var UIArenaMatchView = (function (_super) {
    __extends(UIArenaMatchView, _super);
    function UIArenaMatchView() {
        _super.call(this);
        this.tick_count = 0;
        this.waiting_tick_timer = null;
        this.has_get_enemy = false;
        this.skinName = "skins.UIArenaMatchViewSkin";
        this.addEventListener(egret.gui.UIEvent.CREATION_COMPLETE, this.onCreationComplete, this);
    }
    var __egretProto__ = UIArenaMatchView.prototype;
    ...
    __egretProto__.initMatchView = function () {
    ...
    __egretProto__.initSelfKnightView = function () {
    ...
    __egretProto__.setEnemyTeamVisible = function (bVisible) {
    ...
    __egretProto__.showEnemyKnights = function () {
    ...
    __egretProto__.getNpcData = function (npc_id) {
    ...
    __egretProto__.initNpcEnemyKnights = function (npc_list) {
    ...
    __egretProto__.initEnemyKnights = function (enemy_list) {
    ...
    __egretProto__.refreshHintText = function () {
        this.label_hint.text = Utils.getRandomHintText();
    };
    __egretProto__.onWaitingTick = function () {
    ...
    __egretProto__.getMatchPlayerInfo = function () {
        Net.matchArenaPlayer();
    };
    __egretProto__.finishGetMatchPlayerInfo = function (result, side, is_npc, datas) {
        if (result != 0) {
            if (result == -2) {
                // 继续等待匹配
                return;
    ...
    __egretProto__.onExitView = function () {
    ...
    return UIArenaMatchView;
})(egret.gui.Panel);
UIArenaMatchView.prototype.__class__ = "UIArenaMatchView";
