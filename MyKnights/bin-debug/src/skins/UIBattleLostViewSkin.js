var skins;
(function (skins) {
    var UIBattleLostViewSkin = (function (_super) {
        __extends(UIBattleLostViewSkin, _super);
        function UIBattleLostViewSkin() {
            _super.call(this);
        ...
        var __egretProto__ = UIBattleLostViewSkin.prototype;
        Object.defineProperty(__egretProto__, "skinParts", {
            get: function () {
                return UIBattleLostViewSkin._skinParts;
            },
            enumerable: true,
            configurable: true
        });
        ...
        __egretProto__.btn_detail_i = function () {
            var t = new egret.gui.Button();
            this.btn_detail = t;
            this.__s(t, ["label", "skinName", "x", "y"], ["详情", skins.BtnRedSmallSkin, 36, 92]);
            return t;
        };
        __egretProto__.btn_ok_i = function () {
            var t = new egret.gui.Button();
            this.btn_ok = t;
            this.__s(t, ["label", "skinName", "x", "y"], ["离开", skins.BtnYellowSmallSkin, 162, 92]);
            return t;
        };
        ...
        __egretProto__.ui_layer_i = function () {
            ...
            t.elementsContent = [this.__4_i(), this.__5_i(), this.__6_i(), this.btn_ok_i(), this.btn_detail_i()];
            return t;
        };
        UIBattleLostViewSkin._skinParts = ["btn_ok", "btn_detail", "ui_layer", "anim_layer"];
        return UIBattleLostViewSkin;
    })(egret.gui.Skin);
    skins.UIBattleLostViewSkin = UIBattleLostViewSkin;
    UIBattleLostViewSkin.prototype.__class__ = "skins.UIBattleLostViewSkin";
})(skins || (skins = {}));
