var skins;
(function (skins) {
    var UICreateKnightNameDialogSkin = (function (_super) {
        __extends(UICreateKnightNameDialogSkin, _super);
        function UICreateKnightNameDialogSkin() {
            _super.call(this);
            this.__s = egret.gui.setProperties;
            this.__s(this, ["height", "width"], [874, 1136]);
            this.elementsContent = [this.__3_i(), this.__4_i(), this.__5_i(), this.__6_i(), this.__7_i(), this.__8_i(), this.cancel_btn_i(), this.ok_btn_i(), this.__9_i(), this.name_edit_i()];
            this.states = [
                new egret.gui.State("normal", []),
                new egret.gui.State("disabled", [])
            ];
        }
        var __egretProto__ = UICreateKnightNameDialogSkin.prototype;
        Object.defineProperty(__egretProto__, "skinParts", {
            get: function () {
                return UICreateKnightNameDialogSkin._skinParts;
            },
            enumerable: true,
            configurable: true
        });
        ...
        __egretProto__.__9_i = function () {
            ...
            this.__s(t, ["fontFamily", "horizontalCenter", "text", "textAlign", "verticalAlign", "verticalCenter", "width"], ["Arial", 1, "输入姓名", "center", "middle", -148.5, 166]);
            return t;
        };
        ...
        UICreateKnightNameDialogSkin._skinParts = ["cancel_btn", "ok_btn", "name_edit"];
        return UICreateKnightNameDialogSkin;
    })(egret.gui.Skin);
    skins.UICreateKnightNameDialogSkin = UICreateKnightNameDialogSkin;
    UICreateKnightNameDialogSkin.prototype.__class__ = "skins.UICreateKnightNameDialogSkin";
})(skins || (skins = {}));
