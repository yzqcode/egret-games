class UIRegisterDialog extends egret.gui.Panel{
    public ok_btn:egret.gui.Button;
    public register_fast_btn:egret.gui.Button;
    public input_id:egret.gui.EditableText;
    public input_password_1:egret.gui.EditableText;
    public input_password_2:egret.gui.EditableText;
    public close_btn:egret.gui.Button;
    public register_fast_label:egret.gui.Label;
    ...
    public showRegisterDialog(guiLayer) {
    ...
    public okCallback(){
        ...
        var psw_1:string = this.input_password_1.text;
        var psw_2:string = this.input_password_2.text;
