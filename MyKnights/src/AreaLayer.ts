class AreaLayer extends egret.DisplayObjectContainer {
    public quest_layer:QuestLayer;
    ...
    private city_list = [];
    public city_top_index:number = 0;

    public constructor() {
        super();
    }

    public initAreaLayer(quest_layer:QuestLayer, area_index:number) {
        ...
        // Add area name
        var area_name_text:egret.TextField = new egret.TextField();
    ...
    public finishCollectCityMoney(city_index, money, next_time) {
    ...
    private getBackgroundName(name) {
        return "area_" + name + "_jpg"
    }

    private getBuildingName(name) {
