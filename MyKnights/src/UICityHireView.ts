class UICityHireView extends egret.gui.Panel {
    ...
    public setDatas(parent, guiLayer) {
        this.ui_parent = parent;
        this.guiLayer = guiLayer;
    }

    public resetCityHireInfo(datas_list) {
    ...
    public finishCityHire(result, data) {
    ...
    public finishRefreshCityHireByDiamond(result, data) {
        if (this.ui_wait != null) {
            this.ui_wait.close();
        }
