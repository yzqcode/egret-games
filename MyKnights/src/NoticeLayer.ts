class NoticeLayer extends egret.DisplayObjectContainer {
    private parent_layer:egret.DisplayObjectContainer = null;

	private notice_label:egret.TextField;
    private notice_bg:egret.Bitmap;
    private notice_bg_mask:egret.Rectangle;

	public notice_text:string = "";

	public constructor() {
        super();
    }

    public showNoticeLayer(notice_text:string, parent:egret.DisplayObjectContainer) {
    ...
    public showNoticeAnim() {
        ...
        tw2.wait(200).to({x:-(G.win_width+1000)}, 20000);
    }
