class Utils {
    ...
    public static UUID_KEY:string = "user_uuid_key";
    public static isExistUUID() {
    ...
    public static saveUUID(uuid:string) {
        GlobalData.uuid = uuid;
    ...
    */
    ...
    private static iLogicRandSeed:number = 0;
    private static iClientRandSeed:number = 0;
    public static initLogicRandSeed(seed:number) {
        Utils.iLogicRandSeed = seed;
    }
    public static initClientRandSeed(seed:number) {
        Utils.iClientRandSeed = seed;
    }
    public static inner_rand(seed) {
        seed ^= 123459876
        seed *= 16807
    ...
    public static LogicRandInt(a, b) {
        var d = b-a+1;
    ...
    public static ClientRandInt(a, b) {
        var d = b-a+1;
    ...
    public static getRandomHintText() {
    ...
    // return "00:00:00"
    public static getTimeStr(seconds_sum:number) {
    ...
    public static showWaitAnim(top_view, callback = null) {
    ...
    public static showToastInfo(guiLayer, strInfo="???", time=0) {
    ...
    public static getKnightHeadNorName(type:number, isPlayer:boolean=false) {
        if (isPlayer) {
    ...
    public static getKnightHeadDeadName(type:number, isPlayer:boolean=false) {
        if (isPlayer) {
    ...
    public static getKnightBigImgName(type:number, isPlayer:boolean=false) {
        if (isPlayer) {
    ...
    public static getSelfKnightBigImgMaskName(type:number, isPlayer:boolean=false) {
        if (isPlayer) {
    ...
    public static getOtherKnightBigImgMaskName(type:number, isPlayer:boolean=false) {
        if (isPlayer) {
    ...
    public static getColorIndex(factor) {
        if (factor < 0.5) {
            // white: [0%, 50%)
            return 1;
        }
    ...
    public static getKnightColorIndex(attack_factor, defense_factor, hp_factor) {
    ...
    public static getKnightPointImgName(attack_factor, defense_factor, hp_factor) {
        var index = Utils.getKnightColorIndex(attack_factor, defense_factor, hp_factor)
        return "color_" + index + "_png";
    }

    public static getOnePointImgName(factor) {
        var index = Utils.getColorIndex(factor)
        return "color_" + index + "_png";
    }
    public static getOnePointImgNameByIndex (index) {
        if(index < 1){
            index = 1;
        }
        if(index > 6){
    ...
    public static getKnightFrameImgName(attack_factor, defense_factor, hp_factor) {
        var index = Utils.getKnightColorIndex(attack_factor, defense_factor, hp_factor)
        return "color_frame_" + index + "_png";
    }

    public static getKnightBigFrameImgName(attack_factor, defense_factor, hp_factor) {
        var index = Utils.getKnightColorIndex(attack_factor, defense_factor, hp_factor)
        return "color_big_frame_" + index + "_png";
    }

    public static getKnightSpecialImgName(attack_factor, defense_factor, hp_factor) {
        var index = Utils.getKnightColorIndex(attack_factor, defense_factor, hp_factor)
        return "color_special_" + index + "_png";
    }

    public static getFrameImgName(factor) {
        var index = Utils.getColorIndex(factor)
        return "color_frame_" + index + "_png";
    }

    public static getValuePanelImgName(factor) {
        var index = Utils.getColorIndex(factor)
        return "color_value_panel_" + index + "_png";
    }

    public static getJobCardImgName(level:number) {
        return "job_big_frame_" + level + "_png";
    }

    public static getKnightTypeName(type) {
    ...
    public static getKnightDragonName(type, isPlayer=false) {
    ...
    public static getPlayerGuildPositionName(position:number) {
    ...
    public static getTimeStrForTick(tick_count:number) {
        var myDate = new Date();
    ...
    public static getSystemOpenText(data:Array<number>) {
        ...
        for (var i = SYSTEM_INDEX.INDEX_JOB; i <= SYSTEM_INDEX.INDEX_HONOR_HIRE; i++) {
            if (Logic.system_status_list[i] == SYSTEM_STATUS.LOCKED
                && data[i] == SYSTEM_STATUS.OPENED) {
    ...
    public static color_label = ["白", "绿", "蓝", "紫", "金", "黑"];
    public static color_quality = [0xe0e0e0, 0x00bf49, 0x0089ff, 0xa757cd, 0xbab01b, 0x000000];
    
    public static getColorLabel(index:number) {
        if(index < 0){
