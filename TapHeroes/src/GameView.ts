...
class GameView extends egret.Sprite {
    ...
    private refreshScene() {
        ...
        if ( ret[0] == null && this.background != null && G.current_bg_name != "beijing_12" ) {
            return
        }
        ...
        for ( var i = 0; i < 4; ++i ) {
            // Create platfrom
            var plat = this.hero_platforms[i]
            if ( plat == null ) {
                plat = new egret.Bitmap()
    ...
    public tryTriggerBaozhu() {
        var baozhu_explode = function() {
            ...
            if ( Logic.explodeBaozhu( this.baozhu_data ) ) {
                GameView.instance().ui_main.refreshAllAboutDamage();
    ...
    public m_bHasShowInfo:boolean = false;
    ...
    public exitChallengeMode() {
        ...
        this.ui_main.refreshAllAboutDamage();
    ...
    public showToast(strInfo : string, time=0) {
